...
<body>
	<%
	User u = (User) session.getAttribute("userrobj");
	%>
	...
	<div class="container-fluid">
		<div class="row p-3">
			...
			List<FashionDtls> list = dao.getAllNewFashion();
					...
					<div class="card-body text-center">
						...
						<div class="row">
							...
							<a href="login.jsp" class="btn btn-danger btn-sm ml-2">Add
								Cart</a> }else{ %> <a
								href="cart?fid=<%=b.getFashionId()%>&&uid=<%=u.getId()%>"
								class="btn btn-danger btn-sm ml-2">Add Cart</a>
							<%
                            }
                            %>
							<a href="" class="btn btn-successr btn-sm ml-1">View Details
							</a> <a href="" class="btn btn-danger btn-sm ml-1"><%=b.getPrice()%></a>
